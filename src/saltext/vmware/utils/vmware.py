...
def get_datastores(
    ...
    if (not get_all_datastores) and backing_disk_ids:
        ...
        props = salt.utils.vmware.utils_common.get_properties_of_managed_object(
...
def get_resource_pools(
    ...
    if datacenter_name:
        ...
        container_ref = utils_common.get_root_folder(service_instance)

    resource_pools = utils_common.get_mors_with_properties(
        service_instance,
        vim.ResourcePool,
