...
NO_CERTIFICATE_ERROR_MSG = "No certificate path specified. Please specify certificate path in cert parameter"
HTTP_ERROR_MSG = "HTTP Error occurred while calling VMC API {} for {}. Please check logs for more details."
SSL_ERROR_MSG = "SSL Error occurred while calling VMC API {} for {}. Please check if the certificate is valid " \
                "and hostname matches certificate common name."
REQUEST_EXCEPTION_MSG = "RequestException occurred while calling VMC API {} for {}. Please check logs for more details."
