...
def _create_payload_for_dhcp_profile(dhcp_profile_id, dhcp_profile_type, user_input):
    ...
    template_data = getattr(
        vmc_templates,
        "create_dhcp_" + dhcp_profile_type + "_profiles",
...
def _update_payload_for_dhcp_profile(dhcp_profile_type, existing_data, user_input):
    ...
    template_data = getattr(
        vmc_templates,
        "update_dhcp_" + dhcp_profile_type + "_profiles",
        vmc_templates.update_dhcp_relay_profiles,
    )
    data = vmc_request.create_payload_for_request(template_data, user_input, existing_data)
    return data
