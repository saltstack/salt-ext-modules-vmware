...
from saltext.vmware.utils import vmc_request, vmc_vcenter_request
...
def get(
    ...
    return vmc_vcenter_request.call_api(method=vmc_constants.GET_REQUEST_METHOD,
                                        url=api_url,
                                        headers=headers,
...
def delete(
    ...
    headers = vmc_vcenter_request.get_headers(hostname, username, password)
    return vmc_vcenter_request.call_api(method=vmc_constants.DELETE_REQUEST_METHOD,
                                        url=api_url,
                                        headers=headers,
...
def update(
    ...
    return vmc_vcenter_request.call_api(method=vmc_constants.PATCH_REQUEST_METHOD,
                                        url=api_url,
                                        headers=headers,
...
def create(
    ...
    payload = _create_payload_for_vm_disk(bus_adapter_type, req_data)

    return vmc_vcenter_request.call_api(method=vmc_constants.POST_REQUEST_METHOD,
                                        url=api_url,
                                        headers=headers,
