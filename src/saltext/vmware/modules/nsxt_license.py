...
def get_licenses(
    ...
    if verify_ssl and not cert:
        result = {"error": "No certificate path specified. Please specify certificate path in cert parameter"}
        return result
    ...
    try:
        ...
        log.error(e)
        result = {"error": "Error occurred while retrieving the license. Please check logs for more details."}
        ...
        log.error(re)
        result = {"error": "Error occurred while retrieving licenses. Please check logs for more details."}
        return result
...
def apply_license(
    ...
    try:
        ...
        log.error(e)
        result = {"error": "Error occurred while applying the license. Please check logs for more details."}
        if e.response.text:
            log.error("Response from NSX Manager {}".format(e.response.text))
            try:
                error_json = e.response.json()
        ...
        log.error(re)
        result = {"error": "Error occurred while applying license. Please check logs for more details."}
        return result
    return response.json()
...
def delete_license(
    ...
    try:
        ...
        log.error(e)
        result = {"error": "Error occurred while deleting the license. Please check logs for more details."}
        # if response contains json, extract error message from it
        if e.response.text:
            log.error("Response from NSX Manager {}".format(e.response.text))
            try:
        ...
        log.error(re)
        result = {"error": "Error occurred while deleting license. Please check logs for more details."}
        return result
