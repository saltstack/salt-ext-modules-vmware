...
_existing_data_2 = {"id": "id_1", "display": "id_1", "ip": "8.8.8.8", "port": "46"}
...
_input_dict_1 = {"display": "id_1", "ip": "8.8.8.8", "tag": "debug", "port": "46"}

_input_dict_2 = {"id": "id_1", "display": "changed", "ip": "8.8.8.8", "tag": "debug", "port": "46"}

_input_dict_3 = {"id": "id_1", "display": "id_1", "ip": "8.8.8.8", "tag": "debug", "port": None}

_input_dict_4 = {"id": "id_1", "display": "id_1", "port": None}
...
def test_check_for_update_returning_false():
    ...
    result = vmc_state._check_for_updates(
        _existing_data_1, _input_dict_1, updatable_keys, allowed_none
    )
    assert not result
...
def test_check_for_update_returning_true_with_input_changed_for_not_none():
    ...
    """
    result = vmc_state._check_for_updates(
        _existing_data_1, _input_dict_2, updatable_keys, allowed_none
    )
    assert result
...
def test_check_for_update_returning_true_with_input_changed_for_allowed_none():
    ...
    """
    result = vmc_state._check_for_updates(
        _existing_data_1, _input_dict_3, updatable_keys, allowed_none
    )
    assert result
...
def test_check_for_update_returning_true_with_field_not_in_existing_data_but_in_input_data_of_allowed_none():
    ...
    """
    result = vmc_state._check_for_updates(
        _existing_data_2, _input_dict_2, updatable_keys, allowed_none
    )
    assert result
...
def test_check_for_update_returning_true_with_field_not_in_existing_data_but_in_input_data():
    ...
    """
    result = vmc_state._check_for_updates(
        _existing_data_3, _input_dict_2, updatable_keys, allowed_none
    )
    assert result
