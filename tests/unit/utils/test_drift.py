...
firewall_rule_old = {
    ...
    "sshServer": {
        ...
        "allowed_hosts": {
            "all_ip": False,
            "ip_address": ["192.168.110.90", "192.168.110.91"],
            "ip_network": [],
        },
    },
}
...
firewall_rule_new = {
    ...
    "sshServer": {
        "enabled": True,
        "allowed_hosts": {"all_ip": False, "ip_address": ["192.168.110.90"], "ip_network": []},
    },
}

firewall_rule_drift = {
    "sshServer": {
        "old": {"allowed_hosts": {"ip_address": ["192.168.110.90", "192.168.110.91"]}},
        "new": {"allowed_hosts": {"ip_address": ["192.168.110.90"]}},
    },
    "sshClient": {
        "old": {
            "enabled": False,
            "allowed_hosts": {"ip_address": [], "all_ip": True, "ip_network": []},
        },
        "new": {
            "enabled": True,
            "allowed_hosts": {
