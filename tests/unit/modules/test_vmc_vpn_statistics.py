                ...
                "rules": [
                    {
                        "sources": [
                            {
                                "subnet": "10.72.115.0/24"
                            },
                            {
                                "subnet": "10.73.216.0/23"
                            }
                        ],
                        "destinations": [
                            {
...
def test_get_l2vpn_statistics_should_return_api_response(mock_call_api):
    mock_call_api.return_value = _get_l2vpn_statistics_data
    assert vmc_vpn_statistics.get_l2vpn_statistics(
        hostname="hostname",
        ...
        tier0_id="tier0_id",
        verify_ssl=False) == _get_l2vpn_statistics_data


@patch.object(vmc_request, 'call_api')
def test_get_l2vpn_sessions_should_return_api_response(mock_call_api):
    mock_call_api.return_value = _get_l2vpn_sessions_data
    assert vmc_vpn_statistics.get_l2vpn_sessions(
        hostname="hostname",
        refresh_key="refresh_key",
        authorization_host="authorization_host",
        org_id="org_id",
        ...
        service_id="service_id",
        tier0_id="tier0_id",
        verify_ssl=False) == _get_l2vpn_sessions_data


@patch.object(vmc_request, 'call_api')
def test_get_ipsec_statistics_should_return_api_response(mock_call_api):
    mock_call_api.return_value = _get_ipsec_statistics_data
    assert vmc_vpn_statistics.get_ipsec_statistics(
        hostname="hostname",
        refresh_key="refresh_key",
        authorization_host="authorization_host",
        org_id="org_id",
        ...
        session_id="session_id",
        tier0_id="tier0_id",
        verify_ssl=False) == _get_ipsec_statistics_data

@patch.object(vmc_request, 'call_api')
def test_get_ipsec_statistics_fail_with_error_1(mock_call_api):
...
@patch.object(vmc_request, 'call_api')
def test_get_ipsec_statistics_fail_with_error_2(mock_call_api):
...
@patch.object(vmc_request, 'call_api')
def test_get_ipsec_session__should_return_api_response(mock_call_api):
    mock_call_api.return_value = _get_ipsec_session_data
    assert vmc_vpn_statistics.get_ipsec_sessions(
        hostname="hostname",
        refresh_key="refresh_key",
        authorization_host="authorization_host",
        org_id="org_id",
        ...
        service_id="service_id",
        tier0_id="tier0_id",
        verify_ssl=False) == _get_ipsec_session_data
