...
def test_get_nat_rules_should_return_api_response(nat_rule_data):
    assert vmc_nat_rules.get(hostname="hostname",
                                  ...
                                  tier1="tier1",
                                  nat="nat",
                                  verify_ssl=False) == nat_rule_data
...
def test_get_nat_rules_called_with_url():
    ...
    with patch("saltext.vmware.utils.vmc_request.call_api", autospec=True) as vmc_call_api:
        result = vmc_nat_rules.get(hostname="hostname",
                                         refresh_key="refresh_key",
                                         authorization_host="authorization_host",
...
def test_create_nat_rule_when_api_should_return_successfully_created_message(mock_vmc_request_call_api):
...
def test_create_nat_rules_called_with_url():
    ...
    with patch("saltext.vmware.utils.vmc_request.call_api", autospec=True) as vmc_call_api:
        result = vmc_nat_rules.create(hostname="hostname",
                                         refresh_key="refresh_key",
                                         authorization_host="authorization_host",
                                         org_id="org_id", sddc_id="sddc_id",
                                         tier1="tier1",
...
def test_delete_nat_rule_when_api_should_return_successfully_deleted_message(mock_vmc_request_call_api):
...
def test_delete_nat_rules_called_with_url():
    ...
    with patch("saltext.vmware.utils.vmc_request.call_api", autospec=True) as vmc_call_api:
        result = vmc_nat_rules.delete(hostname="hostname",
                                         refresh_key="refresh_key",
                                         authorization_host="authorization_host",
                                         org_id="org_id", sddc_id="sddc_id",
                                         tier1="tier1",
...
def test_update_nat_rule_when_api_should_return_successfully_updated_message(mock_vmc_request_call_api):
...
def test_update_nat_rule_called_with_url():
    ...
    with patch("saltext.vmware.utils.vmc_request.call_api", autospec=True) as vmc_call_api:
        result = vmc_nat_rules.update(hostname="hostname",
                                         refresh_key="refresh_key",
                                         authorization_host="authorization_host",
                                         org_id="org_id", sddc_id="sddc_id",
                                         tier1="tier1",
...
def test_update_nat_rule_when_api_returns_no_nat_rule_with_given_id(mock_vmc_request_call_api):
