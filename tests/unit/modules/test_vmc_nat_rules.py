...
def test_create_nat_rule_when_api_should_return_successfully_created_message(
...
def test_delete_nat_rule_when_api_should_return_successfully_deleted_message(
    mock_vmc_request_call_api,
):
...
def test_update_nat_rule_when_api_should_return_successfully_updated_message(
    mock_vmc_request_call_api,
):
